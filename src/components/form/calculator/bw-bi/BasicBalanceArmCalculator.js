...
export default function BasicBalanceArmCalculator(props) {
  const { weight } = props;
  const { index } = props;
  ...
  return (
    <div className="calculator-wrapper">
      ...
      <div className="calculator-right">
        <span className="calculator-label">Calculate Balance Arm from Basic Index</span>
      </div>
    </div>
  );
}

BasicBalanceArmCalculator.propTypes = {
