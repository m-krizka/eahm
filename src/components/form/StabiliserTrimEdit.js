...
import Spreadsheet from './stabiliserTrim/Spreadsheet';
import PlanPlaceholder from './stabiliserTrim/PlanPlaceholder';
import constructGrid from './stabiliserTrim/constructGrid';
...
class StabiliserTrimEdit extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      constants: {
...
StabiliserTrimEdit.prototype.handleFieldChange = formMethods.handleFieldChange;
StabiliserTrimEdit.prototype.handleSelectChange = formMethods.handleSelectChange;
StabiliserTrimEdit.prototype.handleDateChange = formMethods.handleDateChange;
StabiliserTrimEdit.prototype.handleRadioChange = formMethods.handleRadioChange;
StabiliserTrimEdit.prototype.handleAircraftSelectChange = formMethods.handleAircraftSelectChange;
StabiliserTrimEdit.prototype.setIndexPerUnit = formMethods.setIndexPerUnit;
StabiliserTrimEdit.prototype.setBalanceArmPerUnit = formMethods.setBalanceArmPerUnit;
StabiliserTrimEdit.prototype.setIndexPerUnitForAll = formMethods.setIndexPerUnitForAll;
StabiliserTrimEdit.prototype.setBalanceArmPerUnitForAll = formMethods.setBalanceArmPerUnitForAll;
...
const connectedStabiliserTrimEdit = connect(mapStateToProps)(StabiliserTrimEdit);
export { connectedStabiliserTrimEdit as StabiliserTrimEdit };
