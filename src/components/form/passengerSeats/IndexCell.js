  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <button onClick={() => setBalanceArmPerUnit(row, indexColumn, balanceArmColumn)} className={hideBtnClass + ' cell-calc-btn'} style={{ float: 'left', color: 'rgb(23, 211, 123)' }}><Glyphicon glyph="arrow-left" /></button>
      </td>
    );
  }
}
