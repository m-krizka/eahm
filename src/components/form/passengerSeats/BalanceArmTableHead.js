...
export default class BalanceArmTableHead extends React.Component {
  ...
  render() {
    ...
    const { setIndexPerUnitForAll, indexColumn, balanceArmColumn } = this.props;
    return (
      <th
      ...
      >
        ...
        <button onClick={() => { setIndexPerUnitForAll(indexColumn, balanceArmColumn); }} type="button" className={hideBtnClass + ' cell-calc-btn'} style={{ float: 'right', color: 'rgb(23, 100, 211)' }}>
