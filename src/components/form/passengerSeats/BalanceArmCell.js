  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <button onClick={() => setIndexPerUnit(row, indexColumn, balanceArmColumn)} type="button" className={hideBtnClass + ' cell-calc-btn'} style={{ float: 'right', color: 'rgb(23, 100, 211)' }}>
