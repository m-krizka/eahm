...
import Spreadsheet from './crewSeats/Spreadsheet';
import PlanPlaceholder from './crewSeats/PlanPlaceholder';
import constructGrid from './crewSeats/constructGrid';
...
const columns = [
  ...
  { name: 'Max Nr. of Seats', key: 'maxNumberOfSeats' },
...
class CrewSeatsEdit extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      constants: {
...
CrewSeatsEdit.prototype.handleFieldChange = formMethods.handleFieldChange;
CrewSeatsEdit.prototype.handleSelectChange = formMethods.handleSelectChange;
CrewSeatsEdit.prototype.handleDateChange = formMethods.handleDateChange;
CrewSeatsEdit.prototype.handleRadioChange = formMethods.handleRadioChange;
CrewSeatsEdit.prototype.handleAircraftSelectChange = formMethods.handleAircraftSelectChange;
CrewSeatsEdit.prototype.setIndexPerUnit = formMethods.setIndexPerUnit;
CrewSeatsEdit.prototype.setBalanceArmPerUnit = formMethods.setBalanceArmPerUnit;
CrewSeatsEdit.prototype.setIndexPerUnitForAll = formMethods.setIndexPerUnitForAll;
CrewSeatsEdit.prototype.setBalanceArmPerUnitForAll = formMethods.setBalanceArmPerUnitForAll;
...
const connectedCrewSeatsEdit = connect(mapStateToProps)(CrewSeatsEdit);
export { connectedCrewSeatsEdit as CrewSeatsEdit };
