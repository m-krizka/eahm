...
class CargoHoldsEdit extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      constants: {
...
CargoHoldsEdit.prototype.handleFieldChange = formMethods.handleFieldChange;
CargoHoldsEdit.prototype.handleSelectChange = formMethods.handleSelectChange;
CargoHoldsEdit.prototype.handleDateChange = formMethods.handleDateChange;
CargoHoldsEdit.prototype.handleRadioChange = formMethods.handleRadioChange;
CargoHoldsEdit.prototype.handleAircraftSelectChange = formMethods.handleAircraftSelectChange;
CargoHoldsEdit.prototype.setIndexPerUnit = formMethods.setIndexPerUnit;
CargoHoldsEdit.prototype.setBalanceArmPerUnit = formMethods.setBalanceArmPerUnit;
CargoHoldsEdit.prototype.setIndexPerUnitForAll = formMethods.setIndexPerUnitForAll;
CargoHoldsEdit.prototype.setBalanceArmPerUnitForAll = formMethods.setBalanceArmPerUnitForAll;
...
const connectedCargoHoldsEdit = connect(mapStateToProps)(CargoHoldsEdit);
export { connectedCargoHoldsEdit as CargoHoldsEdit };
