...
class StabiliserTrimAdd extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      constants: {
...
StabiliserTrimAdd.prototype.handleFieldChange = formMethods.handleFieldChange;
StabiliserTrimAdd.prototype.handleSelectChange = formMethods.handleSelectChange;
StabiliserTrimAdd.prototype.handleDateChange = formMethods.handleDateChange;
StabiliserTrimAdd.prototype.handleRadioChange = formMethods.handleRadioChange;
StabiliserTrimAdd.prototype.handleAircraftSelectChange = formMethods.handleAircraftSelectChange;
StabiliserTrimAdd.prototype.setIndexPerUnit = formMethods.setIndexPerUnit;
StabiliserTrimAdd.prototype.setBalanceArmPerUnit = formMethods.setBalanceArmPerUnit;
StabiliserTrimAdd.prototype.setIndexPerUnitForAll = formMethods.setIndexPerUnitForAll;
StabiliserTrimAdd.prototype.setBalanceArmPerUnitForAll = formMethods.setBalanceArmPerUnitForAll;
...
const connectedStabiliserTrimAdd = connect(mapStateToProps)(StabiliserTrimAdd);
export { connectedStabiliserTrimAdd as StabiliserTrimAdd };
