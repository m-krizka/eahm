...
class GalleysAdd extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      constants: {
...
GalleysAdd.prototype.handleFieldChange = formMethods.handleFieldChange;
GalleysAdd.prototype.handleSelectChange = formMethods.handleSelectChange;
GalleysAdd.prototype.handleDateChange = formMethods.handleDateChange;
GalleysAdd.prototype.handleRadioChange = formMethods.handleRadioChange;
GalleysAdd.prototype.handleAircraftSelectChange = formMethods.handleAircraftSelectChange;
GalleysAdd.prototype.setIndexPerUnit = formMethods.setIndexPerUnit;
GalleysAdd.prototype.setBalanceArmPerUnit = formMethods.setBalanceArmPerUnit;
GalleysAdd.prototype.setIndexPerUnitForAll = formMethods.setIndexPerUnitForAll;
GalleysAdd.prototype.setBalanceArmPerUnitForAll = formMethods.setBalanceArmPerUnitForAll;
...
const connectedGalleysAdd = connect(mapStateToProps)(GalleysAdd);
export { connectedGalleysAdd as GalleysAdd };
