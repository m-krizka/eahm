...
class PotableWaterAdd extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      constants: {
...
PotableWaterAdd.prototype.handleFieldChange = formMethods.handleFieldChange;
PotableWaterAdd.prototype.handleSelectChange = formMethods.handleSelectChange;
PotableWaterAdd.prototype.handleDateChange = formMethods.handleDateChange;
PotableWaterAdd.prototype.handleRadioChange = formMethods.handleRadioChange;
PotableWaterAdd.prototype.handleAircraftSelectChange = formMethods.handleAircraftSelectChange;
PotableWaterAdd.prototype.setIndexPerUnit = formMethods.setIndexPerUnit;
PotableWaterAdd.prototype.setBalanceArmPerUnit = formMethods.setBalanceArmPerUnit;
PotableWaterAdd.prototype.setIndexPerUnitForAll = formMethods.setIndexPerUnitForAll;
PotableWaterAdd.prototype.setBalanceArmPerUnitForAll = formMethods.setBalanceArmPerUnitForAll;
...
const connectedPotableWaterAdd = connect(mapStateToProps)(PotableWaterAdd);
export { connectedPotableWaterAdd as PotableWaterAdd };
