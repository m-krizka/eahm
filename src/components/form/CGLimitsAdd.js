...
class CGLimitsAdd extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      constants: {
  ...
  handleSubmit(event) {
    ...
    parsedRecord.gridFwd = parseGridToDB(parsedRecord.gridFwd, columns);
    parsedRecord.gridAft = parseGridToDB(parsedRecord.gridAft, columns);
...
CGLimitsAdd.prototype.handleFieldChange = formMethods.handleFieldChange;
CGLimitsAdd.prototype.handleSelectChange = formMethods.handleSelectChange;
CGLimitsAdd.prototype.handleDateChange = formMethods.handleDateChange;
CGLimitsAdd.prototype.handleRadioChange = formMethods.handleRadioChange;
CGLimitsAdd.prototype.handleAircraftSelectChange = formMethods.handleAircraftSelectChange;
...
const connectedCGLimitsAdd = connect(mapStateToProps)(CGLimitsAdd);
export { connectedCGLimitsAdd as CGLimitsAdd };
