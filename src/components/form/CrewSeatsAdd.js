...
class CrewSeatsAdd extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      constants: {
...
CrewSeatsAdd.prototype.handleFieldChange = formMethods.handleFieldChange;
CrewSeatsAdd.prototype.handleSelectChange = formMethods.handleSelectChange;
CrewSeatsAdd.prototype.handleDateChange = formMethods.handleDateChange;
CrewSeatsAdd.prototype.handleRadioChange = formMethods.handleRadioChange;
CrewSeatsAdd.prototype.handleAircraftSelectChange = formMethods.handleAircraftSelectChange;
CrewSeatsAdd.prototype.setIndexPerUnit = formMethods.setIndexPerUnit;
CrewSeatsAdd.prototype.setBalanceArmPerUnit = formMethods.setBalanceArmPerUnit;
CrewSeatsAdd.prototype.setIndexPerUnitForAll = formMethods.setIndexPerUnitForAll;
CrewSeatsAdd.prototype.setBalanceArmPerUnitForAll = formMethods.setBalanceArmPerUnitForAll;
...
const connectedCrewSeatsAdd = connect(mapStateToProps)(CrewSeatsAdd);
export { connectedCrewSeatsAdd as CrewSeatsAdd };
